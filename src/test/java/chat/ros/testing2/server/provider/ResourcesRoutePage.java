    ...
    public void beforeEach(ExtensionContext context) throws Exception {
        ...
        if(classTest.contains("TestProviderRouteSimpleMode")){
            if(methodTest.equals("test_Add_Incoming_Route_Simple_Mode")
                    ...
                    || methodTest.equals("test_Header_Modal_Window_When_Add_Route_Button_Create_Route")
                    || methodTest.equals("test_Header_Modal_Window_When_Add_Route_Button_New_Route")
            )
                Assumptions.assumeTrue(TestStatusResult.getTestResult().get("test_Add_Provider_For_Route_In_Simple_Mode"),
                    ...
                    || methodTest.equals("test_Header_Modal_Window_After_Add_Incoming_Route")
            ) {
                Assumptions.assumeTrue(TestStatusResult.getTestResult().get("test_Add_Provider_For_Route_In_Simple_Mode"),
                        "Test failed - adding a provider for tests route in simple mode. Skip the test!");
                Assumptions.assumeTrue(TestStatusResult.getTestResult().get("test_Add_Incoming_Route_Simple_Mode"),
                    ...
                    || methodTest.equals("test_Header_Modal_Window_After_Edit_Incoming_Route_From_Simple_To_Expert_Mode")
            ) {
                Assumptions.assumeTrue(TestStatusResult.getTestResult().get("test_Add_Provider_For_Route_In_Simple_Mode"),
                        "Test failed - adding a provider for tests route in simple mode. Skip the test!");
                Assumptions.assumeTrue(TestStatusResult
                    ...
                    || methodTest.equals("test_Header_Modal_Window_After_Add_Outgoing_Route")
            ) {
                Assumptions.assumeTrue(TestStatusResult.getTestResult().get("test_Add_Provider_For_Route_In_Simple_Mode"),
                        "Test failed - adding a provider for tests route in simple mode. Skip the test!");
